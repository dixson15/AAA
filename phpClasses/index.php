...
<body>
	...
	<ul>
	 ...
	 <!--  <li><a href="#contact">Contact</a></li>
	  <li ><a align="right" href="#about">About</a></li> -->
	</ul>
		 ...
		 <p>SIGN UP</p>
		    <form>
			    ...
			    <select align="">
			      ...
			      <input class="w3-input w3-border w3-sand" type="text" name="" placeholder="First name" required><br>
			      <input  class="w3-input w3-border w3-sand" type="text" name="" placeholder="Last name" required><br>
			      <input class="w3-input w3-border w3-sand" type="text" name="" placeholder="Email ID" required><br>
			      <input class="w3-input w3-border w3-sand" type="text" name="" placeholder="Password" required><br>
			      <input class="w3-input w3-border w3-sand" type="text" name="" placeholder="Confirm password" required><br>
